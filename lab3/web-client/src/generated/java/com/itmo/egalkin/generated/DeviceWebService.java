...
public interface DeviceWebService {
     ...
     * @throws InvalidReleaseYearException
    ...
    public String updateDevice(
        ...
        @WebParam(name = "arg5", targetNamespace = "")
        int arg5)
        throws DeviceNotFoundException, IllegalNameException, InvalidReleaseYearException, NegativePriceException
    ;
    ...
    public long createDevice(
        ...
        @WebParam(name = "arg4", targetNamespace = "")
        int arg4)
        throws IllegalNameException, InvalidReleaseYearException, NegativePriceException
    ;
     ...
     * @param arg0
     * @return
     *     returns javax.xml.ws.Response<com.itmo.egalkin.generated.GetDeviceResponse>
     */
    @WebMethod(operationName = "getDevice")
    @RequestWrapper(localName = "getDevice", targetNamespace = "http://service.egalkin.itmo.com/", className = "com.itmo.egalkin.generated.GetDevice")
    @ResponseWrapper(localName = "getDeviceResponse", targetNamespace = "http://service.egalkin.itmo.com/", className = "com.itmo.egalkin.generated.GetDeviceResponse")
    public Response<GetDeviceResponse> getDeviceAsync(
        @WebParam(name = "arg0", targetNamespace = "")
        long arg0);
    ...
    @RequestWrapper(localName = "getDevice", targetNamespace = "http://service.egalkin.itmo.com/", className = "com.itmo.egalkin.generated.GetDevice")
    @ResponseWrapper(localName = "getDeviceResponse", targetNamespace = "http://service.egalkin.itmo.com/", className = "com.itmo.egalkin.generated.GetDeviceResponse")
    public Future<?> getDeviceAsync(
        @WebParam(name = "arg0", targetNamespace = "")
        long arg0,
        @WebParam(name = "asyncHandler", targetNamespace = "")
        AsyncHandler<GetDeviceResponse> asyncHandler);

    /**
     * 
     * @param arg0
     * @return
     *     returns com.itmo.egalkin.generated.Device
     * @throws DeviceNotFoundException
     */
    @WebMethod
    @WebResult(targetNamespace = "")
     ...
     * @param arg0
     * @return
     *     returns javax.xml.ws.Response<com.itmo.egalkin.generated.UploadDeviceImageMockResponse>
     */
    @WebMethod(operationName = "uploadDeviceImageMock")
    @RequestWrapper(localName = "uploadDeviceImageMock", targetNamespace = "http://service.egalkin.itmo.com/", className = "com.itmo.egalkin.generated.UploadDeviceImageMock")
    @ResponseWrapper(localName = "uploadDeviceImageMockResponse", targetNamespace = "http://service.egalkin.itmo.com/", className = "com.itmo.egalkin.generated.UploadDeviceImageMockResponse")
    public Response<UploadDeviceImageMockResponse> uploadDeviceImageMockAsync(
        @WebParam(name = "arg0", targetNamespace = "")
        Image arg0);
    ...
    @RequestWrapper(localName = "uploadDeviceImageMock", targetNamespace = "http://service.egalkin.itmo.com/", className = "com.itmo.egalkin.generated.UploadDeviceImageMock")
    @ResponseWrapper(localName = "uploadDeviceImageMockResponse", targetNamespace = "http://service.egalkin.itmo.com/", className = "com.itmo.egalkin.generated.UploadDeviceImageMockResponse")
    public Future<?> uploadDeviceImageMockAsync(
        @WebParam(name = "arg0", targetNamespace = "")
        Image arg0,
        @WebParam(name = "asyncHandler", targetNamespace = "")
        AsyncHandler<UploadDeviceImageMockResponse> asyncHandler);
    ...
    @RequestWrapper(localName = "uploadDeviceImageMock", targetNamespace = "http://service.egalkin.itmo.com/", className = "com.itmo.egalkin.generated.UploadDeviceImageMock")
    @ResponseWrapper(localName = "uploadDeviceImageMockResponse", targetNamespace = "http://service.egalkin.itmo.com/", className = "com.itmo.egalkin.generated.UploadDeviceImageMockResponse")
    public String uploadDeviceImageMock(
        @WebParam(name = "arg0", targetNamespace = "")
        Image arg0);
