...
public class ObjectFactory {
    ...
    private final static QName _DeviceNotFoundException_QNAME = new QName("http://service.egalkin.itmo.com/", "DeviceNotFoundException");
    ...
    private final static QName _GetDevice_QNAME = new QName("http://service.egalkin.itmo.com/", "getDevice");
    private final static QName _NegativePriceException_QNAME = new QName("http://service.egalkin.itmo.com/", "NegativePriceException");
    private final static QName _InvalidReleaseYearException_QNAME = new QName("http://service.egalkin.itmo.com/", "InvalidReleaseYearException");
    ...
    private final static QName _IllegalNameException_QNAME = new QName("http://service.egalkin.itmo.com/", "IllegalNameException");
    private final static QName _GetDeviceResponse_QNAME = new QName("http://service.egalkin.itmo.com/", "getDeviceResponse");
    ...
    /**
     * Create an instance of {@link DefaultServiceFault }
     * 
     */
    public DefaultServiceFault createDefaultServiceFault() {
        return new DefaultServiceFault();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link DefaultServiceFault }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://service.egalkin.itmo.com/", name = "DeviceNotFoundException")
    public JAXBElement<DefaultServiceFault> createDeviceNotFoundException(DefaultServiceFault value) {
        return new JAXBElement<DefaultServiceFault>(_DeviceNotFoundException_QNAME, DefaultServiceFault.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.egalkin.itmo.com/", name = "getDevice")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.egalkin.itmo.com/", name = "NegativePriceException")
    public JAXBElement<DefaultServiceFault> createNegativePriceException(DefaultServiceFault value) {
        return new JAXBElement<DefaultServiceFault>(_NegativePriceException_QNAME, DefaultServiceFault.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.egalkin.itmo.com/", name = "InvalidReleaseYearException")
    public JAXBElement<DefaultServiceFault> createInvalidReleaseYearException(DefaultServiceFault value) {
        return new JAXBElement<DefaultServiceFault>(_InvalidReleaseYearException_QNAME, DefaultServiceFault.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.egalkin.itmo.com/", name = "IllegalNameException")
    public JAXBElement<DefaultServiceFault> createIllegalNameException(DefaultServiceFault value) {
        return new JAXBElement<DefaultServiceFault>(_IllegalNameException_QNAME, DefaultServiceFault.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.egalkin.itmo.com/", name = "getDeviceResponse")
